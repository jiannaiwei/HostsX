...
set files=Version.txt Rd.txt 1.txt 1Key.txt SiteEN.txt SiteCN.txt Media.txt Active.txt Game.txt Soft.txt Mobile.txt UnionEN.txt UnionCN.txt Dnt.txt Hijack.txt HijackIP.txt Virus.txt Popups.txt
