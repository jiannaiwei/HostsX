...
c:> "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\static.youku.com" >nul 2>nul
rd "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\player.pplive.cn" /s/q >nul 2>nul
c:> "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\player.pplive.cn" >nul 2>nul
rd "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\irs01.net" /s/q >nul 2>nul
c:> "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\irs01.net" >nul 2>nul
rd "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\www.iqiyi.com" /s/q >nul 2>nul
c:> "%APPDATA%\Macromedia\Flash Player\#SharedObjects\!str!\www.iqiyi.com" >nul 2>nul
