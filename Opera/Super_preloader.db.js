...
(function(){
	...
	var SITEINFO=[
		...
		{siteName:'家电论坛帖子页面',
			url:/http:\/\/www\.jd-bbs\.com\/forum/i,
			siteExample:'http://www.jd-bbs.com/forum-25-4.html',
		...
		{siteName:'家电论坛帖子内容页面',
			url:/http:\/\/www\.jd-bbs\.com\/thread/i,
			siteExample:'http://www.jd-bbs.com/thread-2582562-1-4.html',
			nextLink:'//div[@class="pages"]/a[@class="next"][@href]',
			autopager:{
				pageElement:'//form[@name="modactions"]',
				replaceE:'//div[@class="pages"]',
