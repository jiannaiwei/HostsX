...
var re_adhost = /\b((new)?ad(?!(am|mission|visor|alur|iumx|ult|vizia|obe.*|min|sl|d|olly.*))|ads\b|adserv|pop(?!ular|corn)|click(?!redblue)|cash(?!back)|banner|bans)/i;
...
function FindProxyForURL(url, host)
{
	...
	//DEBUG2 || ((m = re_banner2.exec(url)) && alertmatch("re_banner2\n0= " + m[0]+"\n1= " + m[1]+"\n2= " + m[2]+"\n3= " + m[3]+"\n4= " + m[4]))
